...
export function getActiveOrders(http: HttpClient, rootUrl: string, params?: GetActiveOrders$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ItemOrderResponse>>> {
